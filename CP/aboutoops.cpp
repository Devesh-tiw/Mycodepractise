...
{
public:
    float recivedmoney(float currentMoney, float factor = 1.04)
    {
    ...
    void getData()
    {
        ...
        while (1)
        {
            ...
            if (f == 1)
            {
                cout << "1.ICICI Bank= 1  " << endl
                     << "2.PNB Bank= 1.5 " << endl
                     << "3.SBI Bank= 1.75" << endl
                     << "4.HDFC Bank= 2 " << endl;
                ...
                {
                    cout << "if you have ammount " << a << " then you get " << recivedmoney(a, 2) << " after one year." << endl
                         << endl;
                }
